...
-- Gov: the marker class is a fixed vocabulary (no identifiers); the example line
-- names Keeper hosts and is hashed.
SELECT
    ...
    hex(SHA256(concat(anyLast(leftUTF8(message, 200)), '%salt%'))) AS example
